...
$i = 1;
$adminmenu[$i]['title'] = _MI_MYFLICKR_ADMIN_HOME ;
$adminmenu[$i]['link'] = 'admin/index.php' ;
$adminmenu[$i]['desc'] = _MI_MYFLICKR_ADMIN_HOME_DESC ;
...
*/
$i++;
$adminmenu[$i]['title'] = _MI_MYFLICKR_ADMIN_ABOUT;
$adminmenu[$i]['link'] = 'admin/about.php';
$adminmenu[$i]['desc'] = _MI_MYFLICKR_ADMIN_ABOUT_DESC;
